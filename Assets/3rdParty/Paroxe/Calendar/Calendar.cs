    ...
    public class Calendar : UIBehaviour
    {
        ...
        public bool Opened
        {
            ...
            set
            {
                if (value != m_Opened)
                {
                    ...
                    m_OpenerImage.transform.localRotation = Quaternion.Euler(0.0f, 0.0f, m_Opened ? 180.0f : 0.0f);
                }
            }
        }
        ...
        private void NotifyDateTimeChanged()
        {
            ...
            if (DateTime != m_PreviousNotificationDateTime)
            {
                ...
                if (m_PreviousNotificationDateTime.CompareTo(new DateTime()) != 0)
        ...
        {
            m_YearsRangeBegin = (DateTime.Year - 16) + m_YearsRangeOffset;
        }
...
////            NotifyDateTimeChanged();
        ...
        public void GoTop(){
            while (m_CurrentPanel < m_Panels.Length - 1){
                GoUp();
            }
            m_ButtonText.text = "Ingrese fecha de nacimiento";
