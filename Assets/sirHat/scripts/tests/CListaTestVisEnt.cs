...
public class CListaTestVisEnt
{

    // Atributos
    private int _cantEjemplos, _cantPractica, _cantTest;
    private Dictionary<int, CEstimuloVisEnt> _estimulos;
    ...
    // Constructor
    public CListaTestVisEnt(string _pathInput, string _pathImages)
    {
        // Inicializamos
        _cantEjemplos = 0;
        _cantPractica = 0;
        ...
        _estimulos = new Dictionary<int, CEstimuloVisEnt>();
        // Leemos el csv
        ...
        for (int _i = 1; _i < _lines.Length; _i++)
        {
            if (_lines[_i] != "")
            {
                CEstimuloVisEnt _estimuloAux = new CEstimuloVisEnt(_lines[_i], _pathImages);
    ...
    public CEstimuloVisEnt ObtenerEstimulo(int _ind)
    {
