...
public class CListaTestDichListMus2
{

    // Atributos
    private int _cantEjemplos, _cantPractica, _cantTest;
    private Dictionary<int, CEstimuloDichListMus2> _estimulos;
    ...
    // Constructor
    public CListaTestDichListMus2(string _pathInput, string _pathAudios)
    {
        // Inicializamos
        _cantEjemplos = 0;
        _cantPractica = 0;
        ...
        _estimulos = new Dictionary<int, CEstimuloDichListMus2>();
        // Leemos el csv
        ...
        for (int _i = 1; _i < _lines.Length; _i++)
        {
            if (_lines[_i] != "")
            {
                CEstimuloDichListMus2 _estimuloAux = new CEstimuloDichListMus2(_lines[_i], _pathAudios);
    ...
    private Dictionary<int, CEstimuloDichListMus2> Aleatorizar(Dictionary<int, CEstimuloDichListMus2> _estimulosOrigen)
    {
        int _largoTotal = _estimulosOrigen.Count;
        int _count = 0;
        Dictionary<int, CEstimuloDichListMus2> _estimulosDestino = new Dictionary<int, CEstimuloDichListMus2>(); 
    ...
    public CEstimuloDichListMus2 ObtenerEstimulo(int _ind)
    {
