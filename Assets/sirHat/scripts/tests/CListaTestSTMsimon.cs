...
public class CListaTestSTMsimon
{

    // Atributos
    private int _cantEjemplos, _cantPractica, _cantTest;
    private Dictionary<int, CEstimuloSTMsimon> _estimulos;
    ...
    private AudioClip _ding, _press;

    // Constructor
    public CListaTestSTMsimon(string _pathInput)
    {
        // Inicializamos
        _cantEjemplos = 0;
        _cantPractica = 0;
        ...
        _estimulos = new Dictionary<int, CEstimuloSTMsimon>();
        // Leemos el csv
        ...
        for (int _i = 1; _i < _lines.Length; _i++)
        {
            if (_lines[_i] != "")
            {
                CEstimuloSTMsimon _estimuloAux = new CEstimuloSTMsimon(_lines[_i]);
    ...
    public CEstimuloSTMsimon ObtenerEstimulo(int _ind)
    {
