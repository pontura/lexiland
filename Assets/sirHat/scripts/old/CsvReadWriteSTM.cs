...
public class CsvReadWriteSTM : MonoBehaviour {
    ...
    public void Save(){
        ...
        rowDataTemp[8] = "word8";
        rowDataTemp[9] = "word9";
        rowDataTemp[10] = "numEl";
        rowDataTemp[11] = "trialType";
        rowDataTemp[12] = "taskPos";
        rowDataTemp[13] = "trialPos";
        rowDataTemp[14] = "resp1";
        rowDataTemp[15] = "resp2";
        rowDataTemp[16] = "resp3";
        rowDataTemp[17] = "resp4";
        rowDataTemp[18] = "resp5";
        rowDataTemp[19] = "resp6";
        rowDataTemp[20] = "resp7";
        rowDataTemp[21] = "resp8";
        rowDataTemp[22] = "resp9";
        rowDataTemp[23] = "acierto";  
        rowDataTemp[24] = "RT";  
        rowData.Add(rowDataTemp);
        ...
        for(int i = 0; i < _task.Count; i++)
        {
            ...
            rowDataTemp[3] = _word3[i];
            rowDataTemp[4] = _word4[i];
            rowDataTemp[5] = _word5[i];
            rowDataTemp[6] = _word6[i];
            rowDataTemp[7] = _word7[i];
            rowDataTemp[8] = _word8[i];
            rowDataTemp[9] = _word9[i];
            rowDataTemp[10] = _numEl[i];
            rowDataTemp[11] = _trialType[i];
            rowDataTemp[12] = _taskPos[i];
            rowDataTemp[13] = _trialPos[i]; 
            rowDataTemp[14] = _resp1[i];
            rowDataTemp[15] = _resp2[i];
            rowDataTemp[16] = _resp3[i];
            rowDataTemp[17] = _resp4[i];
            rowDataTemp[18] = _resp5[i];
            rowDataTemp[19] = _resp6[i];
            rowDataTemp[20] = _resp7[i];
            rowDataTemp[21] = _resp8[i];
            rowDataTemp[22] = _resp9[i];
            rowDataTemp[23] = _acierto[i];  
            rowDataTemp[24] = _RT[i];
            rowData.Add(rowDataTemp);
        }
    ...
    private string getPath(){
        #if UNITY_EDITOR
        return Application.dataPath +"/CSV/"+ _id + "_" +  DateTime.Now.ToString().Replace("/","").Replace(":","").Replace(" ","_") + "_" + _sesion + "_STM";
#elif UNITY_ANDROID
