...
public class CVocabulario : MonoBehaviour {
    ...
    void Start()
    {
        //StartCoroutine(TestVocabulario());
    }
    ...
    //// Test
    private IEnumerator TestVocabulario()
    {
            // Seteos iniciales
            inicializacion();
    ...
    public void salirTestVocabulario()
    {        
        _configH.marcarTareaVocabulario(); 
        StopAllCoroutines();
        if (!_conf)
        {
    ...
    private void cargarDiccionario()
    {
        ...
        for (int _i = 1; _i < _lines.Length; _i++)
        {
            ...
            // Audios
             _audioLetra1 = Resources.Load<AudioClip>("audios/vocabulario/" + _lineData[13]);
            ...
            {
                _imagenes[_j] = Resources.Load<Sprite>("imagenes/vocabulario/" + _palabras[_j]);
            }           
